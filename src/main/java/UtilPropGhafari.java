...
public class UtilPropGhafari {
   static final boolean _W = System.getProperty("os.name").toLowerCase().contains("windows");
   static String _PROP_FILENAME_WIN_LOCAL = "C:\\Users\\HP\\Desktop\\ToDo_webprojedct\\Development_Environmental_Set_Up\\webproject\\src\\main\\webapp\\config.properties";
